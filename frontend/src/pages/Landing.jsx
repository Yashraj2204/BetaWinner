...
const FEATURES = [
  {
    ...
    desc: "Log transport, energy, food & shopping with science-backed emission factors. See your impact instantly.",
    span: "md:col-span-2",
    dark: true,
  },
  {
    ...
    desc: "EcoPilot analyzes your real habits and writes a personalized action plan with estimated savings.",
    span: "",
    dark: false,
  },
  {
    ...
    desc: "Daily trends, category breakdowns, and weekly comparisons against the global average.",
    span: "",
    dark: false,
  },
  {
    ...
    desc: "Build the habit. Earn badges, keep your streak alive, and watch your footprint shrink.",
    span: "md:col-span-2",
    dark: false,
    accent: true,
  },
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 bg-white border border-[#E5E2DA] rounded-xl p-5 shadow-sm">
              <p className="text-xs tracking-[0.2em] uppercase text-[#4A5A50] mb-1">
                Global avg / person
              </p>
              <p className="font-heading text-3xl font-extrabold">
                12.9 kg <span className="text-base font-medium text-[#4A5A50]">CO₂ / day</span>
              </p>
      ...
      <section className="border-y border-[#E5E2DA] bg-white">
        <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-3 gap-6 text-center md:text-left">
          {[
            ...
            <div key={label}>
              <p className="font-heading text-3xl md:text-4xl font-extrabold text-[#1A2E20]">
                {num}
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {FEATURES.map((f, i) => (
              ...
              >
                ...
                <p
                  className={`text-sm leading-relaxed ${f.dark ? "text-white/70" : "text-[#4A5A50]"}`}
                >
                  {f.desc}
                </p>
              </motion.div>
      ...
      <footer className="border-t border-[#E5E2DA] py-8 px-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between text-sm text-[#4A5A50]">
          <span className="flex items-center gap-2">
            <Leaf className="w-4 h-4 text-[#2D5A3F]" /> EcoTrace
          </span>
