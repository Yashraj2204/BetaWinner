...
describe("buildStats — empty activities", () => {
  ...
  test("trees_to_offset_month is at least 1", () => expect(stats.trees_to_offset_month).toBeGreaterThanOrEqual(1));
...
describe("buildStats — vs_global_pct", () => {
  ...
  test("returns >100 when above global average", () => {
    const activities = [{ id: "x", date: TODAY, category: "food", co2_kg: GLOBAL_WEEKLY_AVG_KG + 10 }];
